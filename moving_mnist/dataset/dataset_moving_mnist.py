...
ROOT = '/home/yhuang2/PROJs/my_moving_mnist/dataset'
...
class MovingMNIST(Dataset):
    def __init__(self,
        ...
        self.pred_idx = seq_length + horizon - 1
...
if __name__ == "__main__":
    ...
    dataset = MovingMNIST(return_label = True)
